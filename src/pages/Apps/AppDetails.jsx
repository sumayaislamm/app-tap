...
import { getInstalled, saveInstalled } from "../../utils/localStorage";
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-4 text-gray-600">
            ...
            <div className=" items-center gap-1">
              ...
              <p className=" "> <span className="text-xs">Downloads</span> <br /> <span className="text-2xl text-black font-bold">{app.downloads}k</span></p>
            </div>
            ...
            <div className=" items-center gap-1">
              ...
              <p className=" "> <span className="text-xs">Average Ratings</span> <br /> <span className="text-2xl text-black font-bold">{app.ratingAvg}</span></p>
            </div>


            <div className=" items-center gap-1">
              <FaUsers className="text-purple-500 text-xl" />
              <p className=" "> <span className="text-xs">Total Reviews</span> <br /> <span className="text-2xl text-black font-bold">{app.reviews}k</span></p>
            </div>
